...
export const CONTENT_BLOCKS: BlockSeed[] = [
  ...
  { key: "about.hero.subhead", page: "about", section: "hero", label: "Subhead", type: "text", value: "A Texas trial firm led by Max Smith, supported by a team that keeps every matter moving — from Fort Worth to Bosque County." },
