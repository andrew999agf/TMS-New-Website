...
export const CONTENT_BLOCKS: BlockSeed[] = [
  ...
  { key: "about.hero.subhead", page: "about", section: "hero", label: "Subhead", type: "text", value: "A trial lawyer who tries cases. Born and raised in Texas with roots going back to the 1800s." },
