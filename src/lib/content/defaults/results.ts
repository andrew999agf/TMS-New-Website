...
export const CASE_RESULTS: CaseResultSeed[] = [
  ...
  {
    category: "appellate",
    title: "Two affirmances and a recovered supersedeas bond",
    stat: "2",
    statLabel: "Appeals defended — both affirmed",
    year: "2025–2026",
    summary:
      "Defended a property owner (appellee) through two separate appeals arising from post-foreclosure litigation. Both judgments affirmed; petition for review dismissed by the Supreme Court of Texas. Recovered the supersedeas bond for the client.",
    detail:
      "Fifth Court of Appeals at Dallas. Both judgments affirmed (Nov. 7, 2025 and Apr. 15, 2026). Petition for review dismissed by the Supreme Court of Texas. Supersedeas bond recovered for the client.",
  ...
  {
    category: "appellate",
    title: "Garnishment dissolved; underlying judgment vacated; funds returned",
    stat: "Funds returned",
  ...
  {
    category: "settlement",
    title: "Six-figure settlement — partnership fraud dispute",
    stat: "Six figures",
    year: "2026",
    practiceSlug: "civil-commercial-litigation",
    sort: 6,
  ...
  {
    category: "settlement",
    title: "Six-figure recovery — uninsured/underinsured motorist claim",
    stat: "Six figures",
    year: "2026",
  ...
  {
    category: "settlement",
    title: "Six-figure settlement — personal-injury matter",
    stat: "Six figures",
    year: "2025",
    practiceSlug: "personal-injury-wrongful-death",
    sort: 8,
  ...
  {
    category: "settlement",
    title: "$50,000 settlement — contract dispute",
    stat: "$50,000",
    year: "2025",
    practiceSlug: "civil-commercial-litigation",
    sort: 9,
  ...
  {
    category: "settlement",
    title: "$15,000 settlement — defamation matter",
    stat: "$15,000",
    year: "2026",
    practiceSlug: "civil-commercial-litigation",
    sort: 10,
