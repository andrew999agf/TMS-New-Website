...
const DDL = [
  ...
  `ALTER TYPE intake_status ADD VALUE IF NOT EXISTS 'letter-sent'`,
  `ALTER TYPE intake_status ADD VALUE IF NOT EXISTS 'converted'`,
  // Engagement letters (generated from the intake workflow).
  `DO $$ BEGIN CREATE TYPE engagement_status AS ENUM ('draft','sent','signed','declined'); EXCEPTION WHEN duplicate_object THEN null; END $$`,
  `CREATE TABLE IF NOT EXISTS engagement_letters (
    id serial PRIMARY KEY,
    intake_id integer,
    client_name varchar(191) NOT NULL,
    business_name varchar(191) NOT NULL DEFAULT '',
    officer_title varchar(128) NOT NULL DEFAULT '',
    and_individually boolean NOT NULL DEFAULT false,
    email varchar(255) NOT NULL DEFAULT '',
    street varchar(255) NOT NULL DEFAULT '',
    city varchar(128) NOT NULL DEFAULT '',
    state varchar(64) NOT NULL DEFAULT 'Texas',
    zip varchar(16) NOT NULL DEFAULT '',
    county varchar(128) NOT NULL DEFAULT '',
    office varchar(16) NOT NULL DEFAULT 'fort-worth',
    ...
    case_styling varchar(255) NOT NULL DEFAULT '',
    phase1_custom text NOT NULL DEFAULT '',
    phase2_custom text NOT NULL DEFAULT '',
    fees jsonb NOT NULL,
