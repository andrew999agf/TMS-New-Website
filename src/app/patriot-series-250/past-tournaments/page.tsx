...
const CHAMPIONS: Record<number, Champion> = {
  ...
  2024: { team: "Founding Fathers", captain: "Eric H." },
  2023: { team: "Whalers", roster: ["Adam H.", "Trey H.", "Brennan B."] },
  2022: { team: "Founding Fathers", captain: "Eric H.", note: "Defeated the Spartans in the final; the Spartans had edged Ironsides 5–4 in their semifinal" },
  2021: { team: "Founding Fathers", captain: "Eric H.", note: "Routed the 3 Musketeers 25–10 in the final" },
