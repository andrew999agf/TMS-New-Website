...
export function LinkTreeDialog({ folderId, folderName, files, onClose }: { folderId: number; folderName: string; files: LT[]; onClose: () => void }) {
  ...
  function buildPdf() {
    ...
    window.open(`/admin/share-folders/${folderId}/linktree?cap=${cap}`, "_blank");
